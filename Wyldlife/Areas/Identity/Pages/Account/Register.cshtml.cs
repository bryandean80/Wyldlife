...
namespace Wyldlife.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Wyldlife - Confirm Your Email",
                        ...
                        $"<br><br><br><img src=\"https://raw.githubusercontent.com/LeoSaucedo/blog/master/assets/images/wyld.jpg \" style=\"height:256px\">");
